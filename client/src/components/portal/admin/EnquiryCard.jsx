...
const STATUS_LABEL = { new: 'New enquiry', contacted: 'Contacted', 'follow-up': 'Follow-up', converted: 'Converted', closed: 'Closed' };
...
export function EnquiryCard({ enquiry, onStatusChange, isPending }) {
