      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onSelect={() => toast('Profile settings are coming soon.')}>Profile</DropdownMenuItem>
            <DropdownMenuItem onSelect={() => toast('Account settings are coming soon.')}>Settings</DropdownMenuItem>
            <DropdownMenuSeparator />
